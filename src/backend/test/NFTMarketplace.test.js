...
describe('NFTMarketplace',  function(){
   ...
   describe ("Deployment",function() {
    ...
    it("Should track feeAcount of the marketplace",async function() {
    ...
    describe("Making marketplace items",function() {
        ...
        it("Should track newly created item, transer NFT from seller to marketplace and aemit offered event",async function(){
    ...
    describe("Purchasing marketplace items",function () {
        ...
        it("Should update item as sold, pay seller, transer NFT to buyer, charge fees and emit a Bought event",async function() {
